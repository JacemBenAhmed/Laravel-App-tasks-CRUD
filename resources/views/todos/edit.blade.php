...
<div class="t" style="margin-top:150px ; margin-left:50px ;">
<h3>Edit Form</h3>
<form action="{{route('todos.update')}}" method="POST">
    @csrf
    @method('PUT')
   <input name="todo_id"  value="{{$todo->id}}"  type="hidden">
  ...
  <div class="form-group">
   ...
   <textarea name="description" id="description"  class="form-control" cols="10" rows="5"  >{{$todo->description}}</textarea>
  </div>
    <div class="mb-3">
